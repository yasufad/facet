...
> **Onboarding.** You own `render` and nothing else. If a change you need reaches into
...
>
> When you are done, write `work/render-01.md` the way **AGENTS.md → Reporting** describes.
