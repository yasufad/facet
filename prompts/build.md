...
> **Onboarding.** You own `build` and nothing else. If a change you need reaches into
...
>
> When you are done, write `work/build-01.md` the way **AGENTS.md → Reporting** describes.
